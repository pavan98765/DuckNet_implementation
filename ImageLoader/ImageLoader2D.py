...
# folder_path = "C:/Users/Jarvis/Desktop/ACAD/CV_419/project/datasets/Kvasir-SEG/train"  # Add the path to your data directory
folder_path = "C:/Users/Jarvis/Desktop/ACAD/CV_419/project/datasets/Kvasir-SEG/train"  # Add the path to your data directory
...
def load_data(img_height, img_width, images_to_be_loaded, dataset):
    ...
    X_train = np.zeros(
        (images_to_be_loaded, img_height, img_width, 3), dtype=np.float32
    )
    ...
    for n, id_ in tqdm(enumerate(train_ids)):
        ...
        pillow_mask = pillow_mask.resize(
            (img_height, img_width), resample=Image.LANCZOS
        )
